...
import com.dimasta.learn.statisticsMicroservice.daos.StatisticsDao;
...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    final StatisticsDao statisticsDao;
    ...
    private List<LinkedHashMap> getNewDataFromToDoMicroservice(String jwt) {
        ...
        ResponseEntity<JsonResponseBody> responseEntity = restTemplate.exchange(
            "http://localhost:8383/showToDos",
            HttpMethod.POST,
            request,
